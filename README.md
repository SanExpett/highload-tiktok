...
Для TikTok критичной функциональностью будет авторизация, загрузка видео, просмотр ленты. Функциональность, 
которая имеет право "отвалиться": лайки, комментарии, просмотры, подписки.
