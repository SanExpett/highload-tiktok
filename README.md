...
На каждом физическом сервере мы настроим 50 сегментов для осуществления процесса разбиения данных на виртуальные шарды. В качестве ключа разбиения используем id.
