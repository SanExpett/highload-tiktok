...
| Сервер            | Хостинг | Процессор                     | Ядра | Оперативная память | Долговременная память        | Приблизительная стоимость за единицу | Амортизация на 5 лет | Сетевая карта | Количество (учитывая реплики) | 
|-------------------|---------|-------------------------------|------|--------------------|------------------------------|--------------------------------------|----------------------|---------------|-------------------------------|
| PostgreSQL        | own     | 2 x Intel Xeon Gold 6248R     | 28   | 384 ГБ DDR4 ECC    | 4 x 1 ТБ NVMe SSD в RAID 10  | $15,000                              | 250 $/мес.           | 10 GbE        |                               |
| MongoDB           | own     | 2 x AMD EPYC 7742             | 64   | 1 ТБ DDR4 ECC      | 8 x 2 ТБ NVMe SSD в RAID 10  | $20,000                              | 330 $/мес.           | 25 GbE        |                               |
| ClickHouse        | own     | 2 x Intel Xeon Platinum 8280  | 28   | 768 ГБ DDR4 ECC    | 8 x 4 ТБ NVMe SSD в RAID 10  | $20,000                              | 330 $/мес.           | 25 GbE        |                               |
| Redis             | own     | 2 x Intel Xeon Gold 6248R     | 28   | 256 ГБ DDR4 ECC    | 2 x 1 ТБ NVMe SSD в RAID 1   | $10,000                              | 170 $/мес.           | 10 GbE        |                               |
| kubenode          | own     | 2 x AMD EPYC 7742             | 64   | 1 ТБ DDR4 ECC      | 4 x 1 ТБ NVMe SSD в RAID 10  | $20,000                              | 330 $/мес.           | 25 GbE        | 1100                          |

Суммарные затраты при собственном хостинге = 250 + 330 + 330 + 170 + 330 = 1410 $/мес.
