...
| Сервер            | Хостинг | Процессор                    | Ядра | Оперативная память | Долговременная память | Приблизительная стоимость за единицу | Амортизация на 5 лет | Сетевая карта | 
|-------------------|---------|------------------------------|------|--------------------|-----------------------|--------------------------------------|----------------------|---------------|
...
| kubenode           | own      | 2 x AMD EPYC 7742            | 64   | 1 ТБ DDR4 ECC      | 4 x 1 ТБ NVMe SSD в RAID 10 | $20,000                              | 330 $/мес.           | 25 GbE        |
