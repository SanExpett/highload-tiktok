...
- При 5 минутном просмотре ленты отправляется около 1000 запросов
...
Если при 5 минутном просмотре ленты отправляется около 1000 запросов, среднее количество запросов в секунду равно:
...
|------------------|----------------------|----------------------------------------------|-----------------------------|------| 
| Публикация видео | 227050                 | 1.4939                                         | 132812 Гбайт/д           | 2623 |
| Просмотр ленты   | Незначителен         | 309.375                                          | 1977539062                 | 28935     |  
