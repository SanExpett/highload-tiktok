...
| Сервер            | Хостинг | Процессор                     | Ядра | Оперативная память | Долговременная память        | Приблизительная стоимость за единицу | Амортизация на 5 лет | Сетевая карта | Количество | 
|-------------------|---------|-------------------------------|------|--------------------|------------------------------|--------------------------------------|----------------------|---------------|------------|
| PostgreSQL        | own     | 2 x Intel Xeon Gold 6248R     | 28   | 384 ГБ DDR4 ECC    | 4 x 1 ТБ NVMe SSD в RAID 10  | $15,000                              | 250 $/мес.           | 10 GbE        | 400        |
| MongoDB           | own     | 2 x AMD EPYC 7742             | 64   | 1 ТБ DDR4 ECC      | 8 x 2 ТБ NVMe SSD в RAID 10  | $20,000                              | 330 $/мес.           | 25 GbE        | 500        |
| ClickHouse        | own     | 2 x Intel Xeon Platinum 8280  | 28   | 768 ГБ DDR4 ECC    | 8 x 4 ТБ NVMe SSD в RAID 10  | $20,000                              | 330 $/мес.           | 25 GbE        | 500        |
| Redis             | own     | 2 x Intel Xeon Gold 6248R     | 28   | 256 ГБ DDR4 ECC    | 2 x 1 ТБ NVMe SSD в RAID 1   | $10,000                              | 170 $/мес.           | 10 GbE        | 100        |
| kubenode          | own     | 2 x AMD EPYC 7742             | 64   | 1 ТБ DDR4 ECC      | 4 x 1 ТБ NVMe SSD в RAID 10  | $20,000                              | 330 $/мес.           | 25 GbE        | 600        |

Суммарные затраты на сервера с собственным хостингом = 250 * 400 + 330 * 500 + 330 * 500 + 170 * 100 + 330 * 600 = 645000 $/мес.

В случае с Amazon S3, плата взимается за Гб, которые мы храним. При стандартной конфигурации плата будет составлять примерно 23 $/Тб. Это около 100000 $/мес. суммарно.
